...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/macisvpn/premiumnow/master/squid.conf"
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/macisvpn/premiumnow/master/squid.conf"
sed -i "s/ipserver/$myip/g" /etc/squid3/squid.conf
sed -i "s/ipserver/$myip/g" /etc/squid/squid.conf

# openvpn
apt-get -y install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.githubusercontent.com/macisvpn/premiumnow/master/openvpn.tar"
cd /etc/openvpn/;tar xf openvpn.tar;rm openvpn.tar
wget -O /etc/rc.local "https://raw.githubusercontent.com/macisvpn/premiumnow/master/rc.local";chmod +x /etc/rc.local
...
wget -O /etc/php/7.0/fpm/pool.d/www.conf "https://raw.githubusercontent.com/macisvpn/premiumnow/master/www.conf"
